            ...
            <div className="grid grid-cols-2 gap-4">
                <div className="grid gap-2">
                  ...
                  <div className="relative">
                    <Input id="password" type={showPassword ? 'text' : 'password'} required className="bg-background pr-10"/>
                    <Button
                      type="button"
                      variant="ghost"
                      size="icon"
                 ...
                 <div className="grid gap-2">
                  ...
                  <div className="relative">
                    <Input id="confirm-password" type={showConfirmPassword ? 'text' : 'password'} required className="bg-background pr-10"/>
                     <Button
                      type="button"
                      variant="ghost"
                      size="icon"
