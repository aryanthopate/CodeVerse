...
export default function NewCoursePage() {
    ...
    return (
        <AdminLayout>
             <div class="space-y-8">
                <div>
                    <h1 class="text-4xl font-bold">Create a New Course</h1>
                    <p class="text-lg text-muted-foreground mt-1">Fill out the details below to add a new course to the platform.</p>
                </div>
                            ...
                            <Card>
                                ...
                                <CardContent class="space-y-4">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <Textarea id="course-description" value={courseDescription} onChange={e => setCourseDescription(e.target.value)} placeholder="A brief summary of the course." class="min-h-[100px]"/>
                                    </div>
