  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    return (
        <Popover open={open} onOpenChange={handleOpenChange}>
            ...
            <PopoverContent align="end" sideOffset={16} className="w-[calc(100vw-2rem)] sm:w-[26rem] h-[70vh] bg-card/80 backdrop-blur-lg border-primary/20 p-0 overflow-hidden rounded-2xl flex flex-col mb-2 sm:mr-4">
